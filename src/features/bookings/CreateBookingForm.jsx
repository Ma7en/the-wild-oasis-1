// هذا الملف المنسوخ من CreateCabinForm
...
import { useUpdatetCabin } from "../cabins/useUpdateCabin";
...
function CreateBookingForm({ bookingToEdit = {}, onCloseModal }) {
    ...
    // console.log(`Boolean:- `, Boolean(editId));
        ...
        <>
            ...
            >
                {/* 
                        startDate,
                    endDate,
                    numNights, // يفضل حسابها من ال sart - and
                    numGuests,
                    totalPrice,
                    status,
